...
const TIERS: Tier[] = [
  {
    ...
    blurb: "Everything for one platform — SAP, Salesforce, or Workday to start.",
    features: [
      "Full validated test-case library with steps, data & roles",
      "Runnable automation scripts (Playwright + one more framework)",
      "Module coverage map & E2E business-process flows",
  ...
  },
  {
    ...
    blurb: "Every premium pack, every platform, plus the E2E scenario vault.",
    features: [
      "All platform packs — current and future",
  ...
  },
  {
    ...
    blurb: "All-Access for your whole QA team, with seat management.",
    features: [
      "Everything in All-Access × 5 seats",
      "One key, five accounts — easy onboarding",
      "Internal-use redistribution rights",
